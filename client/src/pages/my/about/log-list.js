const logList = [
  ...
  // },
  {
    date: '2022年1月3日',
    version: 'V2.0.2',
    content: `账单页修复月支出未计算出时的显示bug；优化部分文案`
  },
  {
    date: '2021年12月5日',
    version: 'V2.0.1',
    content: `账单页增加底部加载更多的提示`
  },
  {
    date: '2021年7月18日',
    version: 'V2.0.0',
    content: `对新版教务处适配，暂时仅开放查成绩功能`
  },
  {
    date: '2021年5月13日',
    version: 'V1.11.7',
  ...
  },
  {
    date: '2021年5月8日',
    version: 'V1.11.6',
    content: `登录页优化；修复课程表数据bug；修复大一同学已绑定校园卡，在设置页仍显示未绑定的bug`
  },
  {
    date: '2021年4月1日',
    version: 'V1.11.5',
  ...
  },
  {
    date: '2021年3月1日',
    version: 'V1.11.2',
    content: `修复部分iOS用户出现的异常`
  },
  {
    date: '2021年2月27日',
    version: 'V1.11.1',
    content: `修复第一次绑定校园卡时无法获取虚拟卡的bug；部分细节优化`
  },
  {
    date: '2021年2月23日',
    version: 'V1.11.0',
    content: `校园卡细节优化；轻提示延迟时间增长；增加设置页，可修改教务处密码；课程表功能优化`
  },
  {
    date: '2021年1月16日',
    version: 'V1.10.3',
    content: `轻提示增加错误图标，更加友好；优化教务处验证码获取；毕业设计页增加下拉刷新`
  },
  {
    date: '2021年1月14日',
    version: 'V1.10.2',
    content: `校园卡账单页优化；学校天气查询功能暂时关闭；成绩查询页样式优化`
  },
  {
    date: '2021年1月12日',
    version: 'V1.10.1',
    content: `查成绩页未查询到数据时增加再次查询功能；第一次登录获取课表的为空的bug修复，学期算法优化`
  },
  {
    date: '2020年12月27日',
    version: 'V1.10.0',
    content: `百宝箱页样式优化；成绩查询功能修复；初次获取课表功能bug修复；校园卡充值增加提示`
  },
  {
    date: '2020年12月16日',
    version: 'V1.9.5',
    content: `图书馆登录功能优化，续借成功后的bug修复；百宝箱页适配小屏手机；月账单页安卓手机字体小的问题修复`
  },
  {
    date: '2020年12月11日',
    version: 'V1.9.4',
  ...
  },
  {
    date: '2020年11月29日',
    version: 'V1.9.2',
    content: `课程表页优化（若滑动时感觉卡顿，可以尝试开启设置中的‘隐藏非本周课程’功能）；获取缓存的bug修复`
  },
  {
    date: '2020年11月25日',
    version: 'V1.9.1',
